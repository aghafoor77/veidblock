...
public class TransactionHeaderCO {
	...
	public TransactionHeaderCO() {

	}

	public TransactionHeaderCO(String ref, String version, String hashPrevBlock, String creationTime, 
			...
			String creatorURL, String signedBy, String signerUrl,
			String signature) {
