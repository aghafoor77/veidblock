...
public class TransactionCO {
	...
	public TransactionCO() {

	}	
	public TransactionCO(String ref, long depth, String hashPrevBlock, String creationTime, String scope, String sender,
			String receiver, String payload, String payloadType, String cryptoOperationsOnPayload, 
			String creatorSignature,
			String creatorURL, String signedBy,
			String signedDate, String signerUrl, String signature) {
		this.ref = ref;
		this.depth = depth; 
